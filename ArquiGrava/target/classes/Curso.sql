...
CREATE PROCEDURE sp_delete_aluno(@id INT, @nome VARCHAR(100), @saida VARCHAR(100) OUTPUT)
AS
	IF(@id IS NOT NULL)
	BEGIN
...
SELECT * FROM curso WHERE codigo = 40
